---
name: "r00-iannuttall-claude-agents--security"
description: >
  🔒 Security & Compliance skill suite derived from iannuttall/claude-agents.
...
```bash
# Install this skill
cp -r . ~/.claude/skills/r00-iannuttall-claude-agents--security/

# In Claude Code
/read ~/.claude/skills/r00-iannuttall-claude-agents--security/SKILL.md
```
